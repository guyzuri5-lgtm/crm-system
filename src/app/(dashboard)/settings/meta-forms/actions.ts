...
function revalidateAll() {
  ...
  // ליד שעובד מחדש יוצר מתעניין חדש, וזה מופיע בשני המסכים האלה.
 ...
 * שויך, משייך את הטופס למעלה ואז לוחץ כאן — והלקוח נכנס למערכת. בלי זה
 * התיקון היה חלקי: הלידים הבאים היו נקלטים, ומי שכבר הגיע היה נשאר
 ...
 *
 * קיים כי לא כל שורה תקועה ניתנת לתיקון: תשלום של לקוח שנרשם בטלפון אחר,
