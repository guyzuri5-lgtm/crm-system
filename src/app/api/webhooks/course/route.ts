 ...
 * שגיאה לדף הנחיתה ולגרום לו להציג ללקוח שההרשמה נכשלה. הוא כן נרשם ללוג,
 ...
 * לקורס, והוא בדיוק הקהל שהמסע למתעניינים מדבר אליו.
 */
async function linkToLegacyCourse(db: Db, contactId: string): Promise<void> {
  ...
  // השלב לא יורד בדרגה, ומי שכבר שילם לא חוזר להיות מתעניין.
