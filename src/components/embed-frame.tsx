 ...
 * ב-layout.tsx קורא את העדפת המערכת של הגולשת, ובתוך iframe אין לו localStorage
 * לקרוא ממנו — כלומר גולשת שהמכשיר שלה במצב כהה קיבלה טופס שחור על דף נחיתה
...
/* ── מה שהטוקנים למטה לא יכולים לכסות ──
   ...
   בשחור. זה מה שהפך את המסגרת למלבן שחור על דף נחיתה קרם אצל כל גולשת
