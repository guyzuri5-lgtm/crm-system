 ...
 *
 * ── למה שעון ישראל ולא של הנמען ──
 * להבדיל מפגישה, לאירוע יש מקום פיזי אחד ושעה אחת. "19:00" הוא השעה שבה
 * הדלת נפתחת בתל אביב, וזו השעה הנכונה לכל מי שמגיע — גם אם הוא קורא
 * את ההודעה מחו"ל.
 */
 ...
 * במסע ובכלל אוטומציה, הטקסט המרונדר הולך ישר ללקוח.
 *
 ...
 * ולקוח שמקבל "{{first_nmae}}" לא מבחין בין השניים.
 */
