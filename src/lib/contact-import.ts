 ...
 * שמתחיל ב-5 או ב-7 מוחזר לצורתו. גם 972 ללא + מטופל, כי כך יוצא מיצוא של
 * גוגל שיטס ומיצוא אנשי קשר של וואטסאפ.
 */
 ...
 * רשומות מימי ManyChat נשמרו כפי ש-Meta שלחה (‎+972507652811‎), והשאלון,
 * הייבוא ו-webhook הוואטסאפ שומרים את מה ש-normalizePhone מחזיר
 * (‎0507652811‎). בלי להשוות את שתי הצורות, אדם שכבר קיים היה נוצר מחדש
 * כרשומה כפולה במקום לעדכן את הקיימת.
 */
