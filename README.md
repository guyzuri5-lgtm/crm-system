...
| יומן גוגל | `freeBusy` בזמן אמת, על היומן הראשי ועל יומנים נוספים לבחירה |
| פגישות שנקבעו | גיבוי ל-freeBusy, כדי שהמערכת תעבוד נכון גם לפני שהיומן חובר |
| הגדרות סוג הפגישה | משך, זמן מגן לפני/אחרי, התראה מוקדמת מינימלית, וכמה ימים קדימה נפתח היומן |
...
- **שעות זמינות והגדרות** — שעות שבועיות, חסימות ידניות, אזור זמן, היומן שאליו נכתבות הפגישות ויומנים נוספים לבדיקת תפוסה.
...
האינטגרציה מול Google Calendar נכתבה לפי התיעוד ולא נבדקה מול חשבון אמיתי — בדיוק כמו שאר האינטגרציות בפרויקט. הבדיקה הראשונה מול חשבון אמיתי היא הרגע לוודא: שהאירוע נוצר עם קישור Meet, שהלקוח מקבל את ההזמנה, ושהזמינות באמת מסתירה שעות תפוסות.
